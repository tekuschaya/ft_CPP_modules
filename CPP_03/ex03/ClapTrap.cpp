...
ClapTrap::ClapTrap()
{
	std::cout << BOLDBLUE << "Create object of ClapTrap class" << std::endl;
}
...
ClapTrap::ClapTrap(std::string name)
{
	...
	this->max_hit_points = 15;
	this->max_energy_points = 1;
	this->level = 1;
	this->melee_attack_damage = 1;
	this->ranged_attack_damage = 1;
	this->armor_damage_reduction = 1;
	std::cout << BOLDBLUE << "I am " << this->name << std::endl;
}

ClapTrap::~ClapTrap()
{
	std::cout << BOLDBLUE << "Destroyed object of ClapTrap class" << std::endl;
}
